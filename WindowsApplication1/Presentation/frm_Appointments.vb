Public Class frm_Appointments
    ...
    Private Sub PutDbo_AppointmentsData1(ByVal dboStaff As Dbo_Appointments)
        ...
        Dbo_Appointments.MCategory = "Academic"
        Dbo_Appointments.MSubCat = "Approved"
        Dbo_Appointments.MPost = Trim(Me.tbPost1.Text).ToString
        Dbo_Appointments.MSubject = Trim(Me.tbSub1.Text).ToString
    ...
    Private Sub PutDbo_AppointmentsData2(ByVal dboStaff As Dbo_Appointments)
        ...
        Dbo_Appointments.MSubject = Trim(Me.tbSub2.Text).ToString
    ...
    Private Sub PutDbo_AppointmentsData3(ByVal dboStaff As Dbo_Appointments)
        ...
        Dbo_Appointments.MSubject = Trim(Me.tbSub3.Text).ToString
    ...
    Private Sub frm_Appointments_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
