Public Class frm_FacultyRetireList
    ...
    Private Sub frm_RetireList_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        If retirelist = 0 Then
            ...
            If singleYear = 1 Then
                ...
                Dim sql1 As String = "select id,[name],[appdatenep],[retdatenep] from teachers where retdatenep like '%" & year & "' and status ='1' and collegeid in(select id from colleges where faculty ='" & facultyid & "')"
        ...
        ElseIf retirelist = 1 Then
            ...
            If singleYear = 1 Then
                ...
                Dim sql2 As String = "select id,[name],[appdatenep],[retdatenep] from staff where retdatenep like '%" & year & "' and status ='1' and collegeid in(select id from colleges where faculty ='" & facultyid & "')"
